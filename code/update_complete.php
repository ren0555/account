...
$pdo -> exec("update spi set family_name='$name1', last_name='$name2',family_name_kana='$name3',last_name_kana='$name4', mail='$mail', password='$password',gender='$gender',postal_code='$yubin',prefecture='$prefecture',address_1='$address1',address_2='$address2',authority='$authority' where id = $id");
